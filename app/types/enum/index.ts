...
export enum NuxtUiIcons {
  ...
  ExternalLink3 = 'fa:external-link',
  ...
  GoogleIcon = 'flat-color-icons:google',
  ...
  Stop = 'ph:prohibit',
  SubAccount = 'bi:grid',
  TableSortAsc = 'i-lucide-arrow-up-narrow-wide',
  TableSortDesc = 'i-lucide-arrow-down-wide-narrow',
  TableSortNormal = 'i-lucide-arrow-up-down',
