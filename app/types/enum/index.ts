...
export enum NuxtUiIcons {
  ...
  ArrowUpRightSquare = 'mynaui:arrow-up-right-square',
  ...
  BarChart3 = 'heroicons-outline:chart-bar',
  Bell = 'tabler:bell',
  Bitcoin = 'hugeicons:bitcoin-04',
  Book = 'heroicons-outline:book-open',
  ...
  ChatBubble = 'heroicons-outline:chat-alt',
  ...
  Dollar = 'heroicons-outline:currency-dollar',
  Download = 'fa6-solid:download',
  Download2 = 'material-symbols:download',
  Download3 = 'lucide:download',
